...
def generate_random_transactions(num_transactions=100):
    ...
    merchants_by_category = {
        ...
        "Healthcare": ["Guardian", "Watsons", "Clinic ABC", "Hospital XYZ", "Pharmacy"],
        "Travel": [
            "Booking.com",
            "Agoda",
            "Expedia",
        ...
        "Education": ["Coursera", "Udemy", "Bookstore", "School Supplies", "Library"],
        "Personal Care": ["Hair Salon", "Spa", "Gym", "Fitness First", "Pure Fitness"],
        "Other": ["Miscellaneous", "Unknown", "Various"],
    }
    ...
    try:
        ...
        for i in range(num_transactions):
            ...
            payment_method_id = (
                random.choice(payment_method_ids) if random.random() < 0.9 else None
            )
        ...
        psycopg2.extras.execute_values(
            cursor, insert_query, transactions, template=None, page_size=100
        )
